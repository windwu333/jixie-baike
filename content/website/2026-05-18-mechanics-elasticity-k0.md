...
draft: false
categories: ["力学与强度分析"]
tags: ["力学与强度分析", "弹性力学", "机械百科", "平面问题"]
keywords: ["平面问题", "空间问题", "接触理论"]
description: "平面问题是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "C"
aliases: ["/p/mechanics-elasticity-k0"]
---
# 平面问题
> 平面问题是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
- **Engineers Edge**: [Massless Circular Plate With Concentrated Center Mass Simply Supported Edges Natural Frequency Equations and Calculator](https://www.engineersedge.com/vibration/massless_circular_plate_with_concentrated_center_mass_14990.htm)   — Engineers Edge
