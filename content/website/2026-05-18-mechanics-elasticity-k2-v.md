...
keywords: ["接触理论", "平面问题", "空间问题", "应用"]
description: "接触理论—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "Start"
aliases: ["/p/mechanics-elasticity-k2-v"]
---
# 接触理论—应用详解
> 接触理论—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
- **Engineers Edge**: [Beam Deflection Calculator and Stress Formulas for a Beam supported One End, Pin Opposite End and Single Moment at Defined Center Location](https://www.engineersedge.com/beam_bending/beam_bending35.htm)   — Engineers Edge
