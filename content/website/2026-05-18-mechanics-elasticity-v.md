...
keywords: ["平面问题", "空间问题", "接触理论", "应用"]
description: "弹性力学—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "Start"
aliases: ["/p/mechanics-elasticity-v"]
---
# 弹性力学概述—应用详解
> 弹性力学—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
## 参见
- [热应力](/p/mechanics-elasticity-v-%E5%8F%82%E8%A7%81-%E7%83%AD%E5%BA%94%E5%8A%9B/)
...
### 参考资料
- **Engineers Edge**: [Hollow Cylinder Rotating Stress Equations and Calculator](https://www.engineersedge.com/calculators/hollow_cylinder_rotating__15879.htm)   — Engineers Edge
- **Engineers Edge**: [Principal Von-Mises Stress Equations and Calculator](https://www.engineersedge.com/material_science/principal_vonmises_stress__13418.htm)   — Engineers Edge
