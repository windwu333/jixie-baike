...
description: "平面问题—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "Start"
aliases: ["/p/mechanics-elasticity-k0-v"]
---
# 平面问题—应用详解
> 平面问题—应用详解是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
- **Engineers Edge**: [AISC Beam Overhanging One Support and Uniformly Distributed Load on Overhang Calculator and Formulas](https://www.engineersedge.com/calculators/aisc_beam_overhanging_one_support_and_16590.htm)   — Engineers Edge
