...
draft: false
categories: ["力学与强度分析"]
tags: ["力学与强度分析", "弹性力学", "机械百科", "接触理论"]
keywords: ["接触理论", "平面问题", "空间问题"]
description: "接触理论是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "C"
aliases: ["/p/mechanics-elasticity-k2"]
---
# 接触理论
> 接触理论是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
### 参考资料
- **Engineers Edge**: [C-Section No. 2 of 1b Loading Concentrated Intermediate Torque applied Deflection and Stress Equatio](https://www.engineersedge.com/calculators/csection_no_2_of_1b_loading_15469.htm)   — Engineers Edge
- **Engineers Edge**: [Malleability - Strength ( Mechanics ) of Materials](https://www.engineersedge.com/material_science/malleability.htm)   — Engineers Edge
