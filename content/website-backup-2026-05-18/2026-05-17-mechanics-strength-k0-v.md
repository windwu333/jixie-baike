...
description: "**应力—应用详解**是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "Start"
aliases: ["/p/mechanics-strength-k0-v"]
---
# 应力—应用详解
> **应力—应用详解**是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
## 参见
- [弯曲应力](/p/mechanics-strength-k0-v-参见-弯曲应力/)
- [接触应力](/p/mechanics-strength-k0-v-参见-接触应力/)
- [正应力](/p/mechanics-strength-k0-v-参见-正应力/)
