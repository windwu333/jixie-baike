...
description: "**摩擦学—应用详解**是力学分析的关键分支，为机械结构的设计和优化提供理论依据。"
quality: "Start"
aliases: ["/p/mechanics-tribology-v"]
---
# 摩擦学概述—应用详解
> **摩擦学—应用详解**是力学分析的关键分支，为机械结构的设计和优化提供理论依据。
<!--more-->
## 基本概念
...
## 参见
- [边界润滑](/p/mechanics-tribology-v-参见-边界润滑/)
- [弹流润滑](/p/mechanics-tribology-v-参见-弹流润滑/)
- [摩擦](/p/mechanics-tribology-v-参见-摩擦/)
